...
l1 = tkinter.Label(root, text="*Only Supported for Python*", font=('bold', 12))
l2 = tkinter.Label(root, text="Select a File")
btn1 = tkinter.Button(root, text="Choose File", command=lambda: openFile())
btn2 = tkinter.Button(root, text="Search(Ctrl+Q)", command=autoSearch)
l3 = tkinter.Label(root, text="Instructions : ")
l4 = tkinter.Label(root, text="1. Select a Code File")
l5 = tkinter.Label(root, text="2. Click the Search Button(Ctrl+Q)")
l6 = tkinter.Label(root, text="3. You will get all the error solutions")
l7 = tkinter.Label(root, text="for the selected code file.")

l1.pack(pady=5)
l2.pack(fill=tkinter.BOTH)
btn1.pack()
btn2.pack(pady=20)
l3.pack()
l4.pack()
